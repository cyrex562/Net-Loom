...
#include "ns_igmp_grp.h"
#include "ns_dhcp_context.h"
#include "ns_dhcp6_context.h"
#include <vector>
#include "ns_auto_ip_state.h"
#include "ns_mld6_group.h"
...
// returns LwipStatus
//
using NetifInitFn = NsStatus (*)(NetworkInterface*);
 ...
 */
using NetifInputFn = NsStatus (*)(PacketContainer*, NetworkInterface*);
...
//
using netif_output_fn = NsStatus (*)(NetworkInterface*,
                                       PacketContainer*,
                                       const Ip4Addr*);
 ...
 */
using netif_output_ip6_fn = NsStatus (*)(NetworkInterface*,
                                           PacketContainer*,
                                           const Ip6Addr*);
 ...
 */
using netif_linkoutput_fn = NsStatus (*)(NetworkInterface*, PacketContainer*);
/** Function prototype for netif status- or link-callback functions. */
using netif_status_callback_fn = void (*)(NetworkInterface*);

/** Function prototype for netif igmp_mac_filter functions */
using NetifIgmpMacFilterFn = NsStatus (*)(NetworkInterface*,
                                                const Ip4Addr*,
                                                NetifMacFilterAction);

/** Function prototype for netif mld_mac_filter functions */
using netif_mld_mac_filter_fn = NsStatus (*)( NetworkInterface*,
                                                const Ip6Addr*,
                                                NetifMacFilterAction);
...
NsStatus send_pkt_to_netif_loop(NetworkInterface& netif, PacketContainer& pkt_buf);

NsStatus poll_netif(NetworkInterface& netif);

NsStatus recv_netif_bytes(NetworkInterface& netif, std::vector<uint8_t>& recvd_bytes, const size_t max_recv_count);


NsStatus init_loop_netif(NetworkInterface& netif, const std::string& if_name = "lo");
