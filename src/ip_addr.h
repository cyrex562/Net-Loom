...
inline bool is_ipaddr_v6(const IpAddr* ipaddr)
{
...
{
    return is_ipaddr_v6(addr1) && is_ipaddr_v6(addr2)
               ? false
...
{
    return ((is_ipaddr_v6(ipaddr)) ? 0 : ip4_addr_isbroadcast(&ipaddr->u_addr.ip4, netif));
}
