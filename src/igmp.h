...
void igmp_input(PacketBuffer& pkt_buf, NetworkInterface& netif, const Ip4Addr& daddr);

LwipStatus igmp_joingroup(const Ip4Addr& ifc_addr, const Ip4Addr& grp_addr);
