...
static NsStatus pppol2tp_write(PppPcb *ppp, uint8_t *ctx, struct PacketContainer *p);
static NsStatus pppol2tp_netif_output(PppPcb *ppp, uint8_t *ctx, struct PacketContainer *p, u_short protocol);
static NsStatus pppol2tp_destroy(PppPcb *ppp, uint8_t *ctx);    /* Destroy a L2TP control block */
...
static void pppol2tp_dispatch_control_packet(Pppol2tpPcb *l2tp, uint16_t port, struct PacketContainer *p, uint16_t ns, uint16_t nr);
static void pppol2tp_timeout(void* arg);
static void pppol2tp_abort_connect(Pppol2tpPcb *l2tp);
static NsStatus pppol2tp_send_sccrq(Pppol2tpPcb *l2tp);
static NsStatus pppol2tp_send_scccn(Pppol2tpPcb *l2tp, uint16_t ns);
static NsStatus pppol2tp_send_icrq(Pppol2tpPcb *l2tp, uint16_t ns);
static NsStatus pppol2tp_send_iccn(Pppol2tpPcb *l2tp, uint16_t ns);
static NsStatus pppol2tp_send_zlb(Pppol2tpPcb *l2tp, uint16_t ns, uint16_t nr);
static NsStatus pppol2tp_send_stopccn(Pppol2tpPcb *l2tp, uint16_t ns);
static NsStatus pppol2tp_xmit(Pppol2tpPcb *l2tp, struct PacketContainer *pb);
static NsStatus pppol2tp_udp_send(Pppol2tpPcb *l2tp, struct PacketContainer *pb);
...
/* Called by PPP core */
static NsStatus pppol2tp_write(PppPcb* ppp, void* ctx, struct PacketContainer* p)
{
    ...
    NsStatus ret = pppol2tp_xmit(l2tp_pcb, ph);
...
static NsStatus pppol2tp_netif_output(PppPcb *ppp, uint8_t *ctx, struct PacketContainer *p, u_short protocol) {
  ...
  NsStatus err; /* @todo: try to use pbuf_header() here! */
...
static NsStatus pppol2tp_destroy(PppPcb *ppp, uint8_t *ctx) {
  Pppol2tpPcb *l2tp = (Pppol2tpPcb *)ctx;
...
static NsStatus pppol2tp_send_sccrq(Pppol2tpPcb *l2tp) {
  ...
  ns_assert("pb->tot_len == pb->len", pb->tot_len == pb->len);
