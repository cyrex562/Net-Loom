...
/**
 * Initialize a ns network interface structure for a loopback interface
 *  @param netif the ns network interface structure for this loopif
...
{
    NsStatus result = STATUS_SUCCESS;
