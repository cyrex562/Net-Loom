...
#include "ns_ip6.h" /* for ip6_input() */
#include "ipv6cp.h"
 ...
 */
bool
ppp_input(PppPcb& ppp_pcb, PacketContainer& pkt_buf, Fsm& lcp_fsm)
{
    // magic_randomize();
...
{
    ip6->word[0] = pp_htonl(0xfe800000);
    ip6->word[1] = 0;
    eui64_copy(eui64, (Eui64*)&ip6->word[2]);
} /********************************************************************
 *
