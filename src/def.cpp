 ...
 */
uint16_t lwip_htons(const uint16_t n) { return pp_htons(n); }

uint16_t lwip_ntohs(const uint16_t n) { return pp_ntohs(n); }

uint32_t lwip_ntohl(const uint32_t n) { return pp_ntohl(n); }
