...
struct netif {
  ...
  uint8_t hwaddr[kNetifMaxHwaddrLen];
...
void netif_ip6_addr_set(struct netif *netif, s8_t addr_idx, const Ip6Addr*addr6);
...
s8_t netif_get_ip6_addr_match(struct netif *netif, const Ip6Addr*ip6addr);
void netif_create_ip6_linklocal_address(struct netif *netif, uint8_t from_mac_48bit);
err_t netif_add_ip6_address(struct netif *netif, const Ip6Addr*ip6addr, s8_t *chosen_idx);
