 ...
 *
 */
static uint8_t pbuf_add_header_impl(struct PacketBuffer* p,
...
static uint8_t pbuf_header_impl(struct PacketBuffer* p,
 ...
 */
        uint16_t pbuf_copy_partial(const struct PacketBuffer* buf,
                                   void* dataptr,
                                   uint16_t len,
                                   uint16_t offset)
        {
 ...
 */
        struct PacketBuffer*pbuf_clone(PbufLayer layer,
                                       PbufType type,
                                       struct PacketBuffer* p)
        {
 ...
 */
        uint16_t pbuf_memcmp(const struct PacketBuffer* p,
                             uint16_t offset,
                             const uint8_t* s2,
                             uint16_t n)
        {
 ...
 */
        uint16_t pbuf_memfind(const struct PacketBuffer* p,
                              const uint8_t* mem,
                              uint16_t mem_len,
                              uint16_t start_offset)
        {
