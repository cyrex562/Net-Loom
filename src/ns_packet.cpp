 ...
 */
void
copy_pkt_buf(PacketContainer& dst_pbuf, PacketContainer& src_pbuf)
{
    dst_pbuf = src_pbuf;
}
 ...
 */
NsStatus
pbuf_take_at(PacketContainer& buf,
 ...
 */
uint8_t
get_pbuf_byte_at(const PacketContainer& p, size_t offset)
{
 ...
 */
NsStatus
pbuf_put_at(PacketContainer& p, size_t offset, uint8_t data)
{
