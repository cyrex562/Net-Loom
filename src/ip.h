 ...
 */
inline NsStatus
ip_output(PacketContainer& p, IpAddrInfo& src, IpAddrInfo& dest, const uint8_t ttl, const uint8_t tos, const uint8_t proto)
{
 ...
 */
inline NsStatus
ip_output_if(PacketContainer& p,
...
///
inline NsStatus
ip_output_if_src(PacketContainer& p,
                 IpAddrInfo& src,
                 const IpAddrInfo& dest,
                 uint8_t ttl,
                 uint8_t tos,
...
NsStatus ip_input(struct PacketContainer *p, NetworkInterface *inp);
