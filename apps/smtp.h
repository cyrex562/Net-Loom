 ...
 */
typedef void (*smtp_result_fn)(void *arg, u8_t smtp_result, uint16_t srv_err, err_t err);
...
struct smtp_bodydh {
  uint16_t state;
  uint16_t length; /* Length of content in buffer */
...
void smtp_set_server_port(uint16_t port);
